    ...
    public class OnlineThread extends AsyncTask<Void, String, Boolean> {
        ...
        protected void onProgressUpdate(String... arg) {
            ...
            try {
                ...
                // UPDATE 'onlineInfo' SET date = ' 2018-10-11 ' where vehicleCode='12131 ';
                String currentDate=getDateTime();
                Log.e("currentdate",currentDate);
               /* if(!newTime.equals(currentDate)) {
                    Log.e("service","inside if");

                    db.update("onlineInfo", values, "vehicleCode = ? AND time < ? ", new String[]{vehiId,newTime});
                }
                else {*/
                Log.e("service","inside else");
